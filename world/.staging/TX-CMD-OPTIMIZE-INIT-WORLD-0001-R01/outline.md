...
volumes:
  ...
  - id: ARC-002
    ...
    entry_cause: 石横携妹进入边军武威营，在军功派与士族空降兵之间周旋，首次直面北狄铁骑与妖患潮。
    goal:
      id: GOAL-ARC-002
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `CH-0001` | `ARC-001` | 饥寒卖血被骗、面板半激活 | 村中断粮断药、幼妹病重 | 血铺压价诈血、无粮无药 | 皮肤濒死、面板以气血寿元为薪激活 | 建立生死主驱动 | 破限提示 | `MS-ARC-001-01` | planned |
| `CH-0002` | `ARC-001` | 第一次加点、气血入体 | 面板可用、濒死苏醒 | 拿命赌命、病儿偷粮 | 皮肉力初成、徒手破柴 | 金手指规则确立 | 里正上门 | `MS-ARC-001-01` | planned |
